                  ...
                  <table class="table table-sm table-hover datatable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <th data-target="name" scope="row" class="text-center" style="width: 10%;">SRA Verbal Form</th>
                        <td class="text-center" style="width: 15%;">/uploads/sra.png</td>

...
<section class="section" style="width: 1960px;">
    <div class="row">
      ...
      <div class="card rounded-0 bg-light">
        <div class="card-body">
          <h5 class="card-title">Student Upload Grade</h5>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center" style="width: 10%;">
                            <a href="./upload_student_grade?student_id=<?php echo $student['id']; ?>" type="submit" class="btn text-white rounded-pill btn-sm w-50" style="background-image: linear-gradient(#4B6F44, #006B3C);"><i class="bi bi-print"></i> Upload</a>
                            <a href="./view_student_grade?student_id=<?php echo $student['id']; ?>" type="submit" class="btn text-white rounded-pill btn-sm w-50" style="background-image: linear-gradient(#AB274F, #9F2B68);"><i class="bi bi-print"></i> View</a>

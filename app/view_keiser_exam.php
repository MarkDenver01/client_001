...
<?php if(isset($_POST["button_back"])) redirect('./third_year_exam', false); ?>
<?php include('../start_menu_bar.php'); ?>

<main id="main" class="main">
  <div class="pagetitle">
    <h1>View Keirsey Temperament Sorter Records</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="index.html">Test Services</a></li>
        <li class="breadcrumb-item active">Third Year</li>
        <li class="breadcrumb-item active">Keirsey Temperament Sorter</li>
      </ol>
    </nav>
  </div><!-- End Page Title -->
                  ...
                  <table class="table table-sm table-hover datatable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <th data-target="name" scope="row" class="text-center" style="width: 10%;">Keirsey Temperament Sorter</th>
                        <td class="text-center" style="width: 15%;">/uploads/keirsey.png</td>

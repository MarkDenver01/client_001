...
// =================== exam image upload ========================== //
$db_sql_11[] = "DROP TABLE IF EXISTS `exam_image_upload`";

$db_sql_11[] = "CREATE TABLE `exam_image_upload` (
  `id` int(11) NOT NULL,
  `student_year` VARCHAR(255) NOT NULL,
  `image_exam_path` VARCHAR(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";

$db_sql_11[] = "ALTER TABLE `exam_image_upload`
ADD PRIMARY KEY(`id`)";

$db_sql_11[] = "ALTER TABLE `exam_image_upload`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT";

$sql_db_11[] = "ALTER TABLE `exam_created`
ADD INDEX student_year (`student_year`)";

// =================== exam schedule ========================== //
$db_sql_12[] = "DROP TABLE IF EXISTS `exam_schedule`";

$db_sql_12[] = "CREATE TABLE `exam_schedule` (
  `id` int(11) NOT NULL,
  `student_year` VARCHAR(255) NOT NULL,
  `exam_title` VARCHAR(255) NOT NULL,
...
$db_sql_12[] = "ALTER TABLE `exam_schedule`
ADD PRIMARY KEY(`id`)";
...
// =================== student records ========================== //
$db_sql_13[] = "DROP TABLE IF EXISTS `student_records`";

$db_sql_13[] = "CREATE TABLE `student_records` (
  `id` int(11) NOT NULL,
  `email_address` VARCHAR(255) NOT NULL,
  `name` VARCHAR(255) NOT NULL,
  ...
  `correct_answer` int(55) NOT NULL,
  `wrong_answer` int(55) NOT NULL,
  `total_items` int(55) NOT NULL,
  `total_average` int(11) NOT NULL,
  `status` VARCHAR(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4";

$db_sql_13[] = "ALTER TABLE `student_records`
ADD PRIMARY KEY(`id`)";

$db_sql_13[] = "ALTER TABLE `student_records`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT";

$sql_db_13[] = "ALTER TABLE `student_records`
ADD INDEX email_address (`email_address`)";

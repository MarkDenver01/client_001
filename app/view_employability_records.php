                  ...
                  <table class="table table-sm table-hover datatable">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <th data-target="name" scope="row" class="text-center" style="width: 10%;">Employability Skills Assessment</th>
                        <td class="text-center" style="width: 15%;">/uploads/esa.png</td>

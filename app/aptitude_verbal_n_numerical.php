              ...
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <table class="table table-hover table-bordered mb-5">
                    ...
                    <tbody>                   
                    <?php       
                      $sql = "SELECT * FROM examinee WHERE student_id ='$student_id' AND exam_title = 'Aptitude Verbal and Numerical'";
                      $result = $db->query($sql);
                      ...
                      <table class="table text-nowrap " id="tableList">
                        <tbody>
                            <?php 
                                ...
                                AND semester ='$semester' AND school_year ='$school_year' AND exam_title = 'Aptitude Verbal and Numerical'";
                                $result = $db->query($sql);
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                ...
                                if ($data >= 70 && $data <=84) { 
                                  ...
                                  } elseif ($data >= 50 && $data <= 69) { 
                                    $exam_result_status = "GOOD";
                                    $msg =$exam_result_status;
                                  } elseif ($data >= 20 && $data <= 49) {
                                  ...
                                  <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                      <div class="text-center">
                                        <h3><?php echo $total_score ." out of 84"; ?></h3>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                          ...
                          document.addEventListener("DOMContentLoaded", () => {
                            new Chart(document.querySelector('#lineChart'), {
                              ...
                              data: {
                                ...
                                datasets: [{
                                  label: 'Aptitude Verbal and Numerical',
                                  data: [
